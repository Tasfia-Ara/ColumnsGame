...
main:
    ...
    move $t2, $v0           # store random colour in $t2
    ...
    sw $t2, 0($t9)          # draw the first block
    sw $t3, 128($t9)        # draw the second block on next row
    sw $t4, 256($t9)        # draw the third block on next row
